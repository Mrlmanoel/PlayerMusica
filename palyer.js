let musicas = [
    { titulo: 'Guiteirra', artista: 'Famuailia', source: '/audio/O HOSMEM COM A GUITEIRRA.mp3', img: '/img/Guterira .png' },
    { titulo: 'Hoje é Meu Aniverseiro', artista: 'Principe Ouro Neigro', source: '/audio/Hoje é meu aniversário.mp3', img: '/img/Ouro Neigro.png' },
    { titulo: 'LINDA LEMBREINÇA DE ANIVERSUAIRO', artista: 'Ouro Neigro', source: '/audio/LINDA LEMBREINÇA DE ANIVERSUAIRO.mp3', img: '/img/Principe .png' }
];
